...
export const API_ENDPOINTS = {
  ...
  USER_CREATED_EVENTS: `${API_CONFIG.BASE_URL}/user/created-events`,
  ...
  EVENT_VOLUNTEER_TASK_NOTE: (eventId: number, userId: number) => `${API_CONFIG.BASE_URL}/events/${eventId}/volunteers/${userId}/task-note`,
  EVENT_COMPLETE: (id: number) => `${API_CONFIG.BASE_URL}/events/${id}/complete`,
  EVENT_CLEANUP_EVIDENCE: (id: number) => `${API_CONFIG.BASE_URL}/events/${id}/cleanup-evidence`,
  ...
  MANUAL_REPORT_DOCUMENTS: `${API_CONFIG.BASE_URL}/manual-report-documents`,
